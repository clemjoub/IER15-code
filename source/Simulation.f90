...
!allocate	(evec(nEps*nhh*death))
!call get_eps(evec,evcv,nEps,nhh,idum,death)
!deallocate	(emat)
!allocate	(emat(nEps,nhh,death)) 
!emat=reshape(evec,(/nEps,nhh,death/))
!deallocate	(evec)
...
open(unit=98708,file=pathoutput//'theta_out_'//specification//'.txt',position='rewind')
