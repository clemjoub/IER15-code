...
nan(:)=0
open (unit=1431,file=pathoutput//'Momentgroups.txt',position='rewind')
...
!if (i.ge.287 .and. i.lt.335) weights(i)=10*weights(i)
!if (i.ge.349 .and. i.lt.397) weights(i)=10*weights(i)
!if (i.ge.417 .and. i.lt.465) weights(i)=10*weights(i)
...
open(unit=1655, file=pathoutput//'moments.txt',position='rewind')
do i=1,nmoments
write(1655,*) m(i)
enddo
close(1655)

open(unit=1654, file=pathoutput//'criterion.txt',position='rewind')
