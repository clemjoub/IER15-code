...
integer::                       runsolution,runcounterf,rungradient, runsimul,runvarcov, verbose1,verbose2, checkprecision, checknumemax    ! control which part of the code to run 
integer::                       quick                                                                                   !runs the code with few states and decisions for speed
character*6::                   specification                                                                           !suffix that identifies current specification
...
double precision::				SR_Fh											! Sector-specific skill rental price
double precision::				SR_Fw											! Sector-specific skill rental price
double precision::				SR_Ih											! Sector-specific skill rental price
double precision::				SR_Iw											! Sector-specific skill rental price
...
integer::						simH_elig		(nhh,nclones)							! Stores Husband eligibility for minimum pension dummy
integer::						simW_elig		(nhh,nclones)							! Stores Wife eligibility for minimum pension dummy
integer::						simH_nonel		(nhh,nclones)							! Stores Husband noneligibility for minimum pension dummy
integer::						simW_nonel		(nhh,nclones)							! Stores Wife noneligibility for minimum pension dummy
integer::						simH_overMP		(nhh,nclones)							! Stores Husband dummy for pension savings above minimum pension
integer::						simW_overMP		(nhh,nclones)							! Stores Wife dummy for pension savings above minimum pension
double precision::				simH_MPbenef	(nhh,nclones)							! Stores Husband minimum pension benefit
double precision::				simW_MPbenef	(nhh,nclones)							! Stores Wife minimum pension benefit
double precision::				simH_WPbenef	(nhh,nclones)							! Stores Husband minimum pension benefit
double precision::				simW_WPbenef	(nhh,nclones)							! Stores Wife minimum pension benefit
double precision::				simH_APS		(nhh,nclones)							! Stores Husband minimum pension benefit
double precision::				simW_APS		(nhh,nclones)							! Stores Wife minimum pension benefit
...
character(len=20)				JLSin, JLSout, tag
