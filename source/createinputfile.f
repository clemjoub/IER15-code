        ...
        subroutine createinputfile(parms,numiter)
	...
	integer maxit,temp2
        ...
        character*50, allocatable :: alabel(:)
        ...
        call Readin(totp,kidmax,ktp,numper,vseed,alpha,abump,aiter,numiter,Sbar,Tbar,nmc,&
             regind,intmat,numint,nsimul,alphalow,alphahigh)
...
!       write out all the ingredients to create a new input file 
        ...
        alabel(1) = 'alpha(1) - crra coefficient'
        ...
        open(unit=100,file='newinputfile.txt',status='UNKNOWN',action='WRITE',position='REWIND')
	...
	Loop4: do i=1,132
	   ...
	   if (i.eq.6.or.i.eq.7.or.i.eq.16.or.i.eq.21.or.i.eq.26.or.i.eq.31.or.i.eq.70.or.i.eq.71) then
	     Loop7: do j = 1,ktp	         
